...
; to go to the next set of credits texts.
	...
	db CRED_US_COORD, CRED_KAWAKAMI, CRED_HI_NAKAMURA, CRED_GIESE, $FC
	db CRED_US_COORD, CRED_OSBORNE, CRED_TRANS, CRED_OGASAWARA, $FC
	db CRED_IWATA, CRED_IZUSHI, CRED_HARADA, $FD
	db CRED_PROGRAMMERS, CRED_PAAD, $40, $FD
	db CRED_SPECIAL, CRED_CLUB, CRED_MURAKAWA, $FC
	db $41, $42, $43, $44, $FD
	db $2A, $3D, $FD
	db $2B, $0C, $FF
	db $FB, $FF, $FA
